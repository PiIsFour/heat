...
class App extends Component {
	constructor (props) {
		...
		const state = composeState()
			.compose('P', 'kW', 55, false, <mrow><mi>P</mi></mrow>)
			.compose('twin', '°C', 20, false, <mrow><msub><mi>T</mi><mi>W in</mi></msub></mrow>)
			.compose('twout', '°C', 30, false, <mrow><msub><mi>T</mi><mi>W out</mi></msub></mrow>)
			.compose('cw', 'kJ/kgK', 4.18, true, <mrow><msub><mi>c</mi><mi>W</mi></msub></mrow>)
			.compose('Mw', 'kg/s', 1, false, <mrow><msub><mi>M</mi><mi>W</mi></msub></mrow>)
			.compose('toin', '°C', 60, false, <mrow><msub><mi>T</mi><mi>O in</mi></msub></mrow>)
			.compose('toout', '°C', 40, false, <mrow><msub><mi>T</mi><mi>O out</mi></msub></mrow>)
			.compose('co', 'kJ/kgK', 2, true, <mrow><msub><mi>c</mi><mi>O</mi></msub></mrow>)
			.compose('Mo', 'kg/s', 1, false, <mrow><msub><mi>M</mi><mi>O</mi></msub></mrow>)
			.compose('A', 'm²', 1, false, <mrow><mi>A</mi></mrow>)
			.compose('k', 'kW/m²K', 1, false, <mrow><mi>k</mi></mrow>)
			.compose('tlog', 'K', 1, false, <mrow><msub><mi>T</mi><mi>log</mi></msub></mrow>)
			.compose('alpha', '', 1, false, <mrow><mi>alpha</mi></mrow>)
			.compose('pw', 'kg/l', 1, true, <mrow><msub><mi>p</mi><mi>W</mi></msub></mrow>)
			.compose('po', 'kg/l', 1, true, <mrow><msub><mi>p</mi><mi>O</mi></msub></mrow>)
			.compose('Qw', 'l/min', 60, false, <mrow><msub><mi>Q</mi><mi>W</mi></msub></mrow>)
			.compose('Qo', 'l/min', 60, false, <mrow><msub><mi>Q</mi><mi>O</mi></msub></mrow>)
		state.all = {
